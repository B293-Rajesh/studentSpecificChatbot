...
class SimpleVectorStore:
    def __init__(self, dim, index_path="vector_index.pkl"):   # ✅ Fixed constructor
        self.dim = dim
    ...
    def add(self, vectors, metas):
        """
        Add vectors and corresponding metadata (chunks of text).
        """
    ...
    def search(self, query_vector, k=3, metric="l2"):
        """
        Search top-k closest vectors.
        Supported metrics: 'l2' (Euclidean), 'cosine'.
        """
    ...
    def _load(self):
        """
        Load vectors + metadata from disk.
        """
